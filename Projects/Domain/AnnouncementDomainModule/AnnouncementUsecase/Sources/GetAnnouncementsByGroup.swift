...
public struct GetAnnouncementsByGroup {
    ...
    public static let mock: [AnnouncementEntity] = [
        ...
        .init(
            ...
            """,
            date: Date.now.addingTimeInterval(7 * 24 * 60 * 60),
            place: .init(
                type: .online,
                name: "구글 밋",
        ...
        .init(
            ...
            """,
            date: Date.now.addingTimeInterval(14 * 24 * 60 * 60),
            place: .init(
                type: .online,
                name: "Zoom 화상회의",
        ...
        .init(
            ...
            """,
            date: Date.now.addingTimeInterval(21 * 24 * 60 * 60),
            todos: [
        ...
        .init(
            ...
            """,
            date: Date.now.addingTimeInterval(28 * 24 * 60 * 60),
            place: .init(
                type: .offline,
                name: "서울 스타트업 허브",
        ...
        .init(
            ...
            """,
            date: Date.now.addingTimeInterval(35 * 24 * 60 * 60),
            place: .init(
                type: .offline,
                name: "코엑스 컨퍼런스룸",
